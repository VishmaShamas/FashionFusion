...
class AppAssets {
  ...
  // static String authBackground = 'assets/auth/authBg.webp';
  static String googleLogo = 'assets/logo/google-icon.svg';
  static String appleLogo = 'assets/logo/apple-icon.svg';
}
