...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  final List<Map<String, String>> bodyTypes = [
    ...
    {
      'label': 'Rectangle',
      'image': 'assets/bodyType/rectangle.jpg', // placeholder, add actual asset if available
      'desc': 'Shoulders & hips same width, no defined waist.',
    },
    {
      'label': 'Triangle',
      'image': 'assets/bodyType/triangle.jpg', // placeholder, add actual asset if available
      'desc': 'Hips wider than shoulders, sloping shoulders.',
    },
    {
      'label': 'Oval',
      'image': 'assets/bodyType/oval.jpg', // placeholder, add actual asset if available
                  ...
                  SizedBox(
                    ...
                    child: PageView.builder(
                      ...
                      controller: PageController(
                          viewportFraction: 0.5, initialPage: selectedBodyTypeIndex),
                      onPageChanged: (i) {
